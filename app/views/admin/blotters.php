                        ...
                        <div class="page-header-content d-lg-flex border-top">
                            <div class="d-flex">
                                <div class="breadcrumb py-2">
                                    ...
                                    <span class="breadcrumb-item">Blotters</span>
                                    ...
                                    <div class="card-header">                                        
                                       <div class="card-title modal-footer justify-content-between">
												...
												<a href="#modal_position" data-bs-toggle="modal" data-bs-target="#modal_position"
                                                    ...
                                                    <i class="ph-person me-2"></i> Add Blotter
                                                    </a>
										</div>	
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered" id="subjectTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?= htmlspecialchars($blotter['Date_Filed']) ?></td>
                                                        <td><?= htmlspecialchars($blotter['Complainant']) ?></td>                                                        
                                                        <td><?= htmlspecialchars($blotter['Person_to_Complain']) ?></td>
                                                        <td><?= htmlspecialchars($blotter['Complaint']) ?></td>
                                                        <td><?= htmlspecialchars($blotter['Status']) ?></td>
