<?php $model = new HouseholdModel();
        $Residents = $model->getAllResidents();
                        ...
                        <div class="page-header-content d-lg-flex">
                            <div class="d-flex">
                                <h4 class="page-title mb-0">
                                    General - <span class="fw-normal">Residents</span>
                                </h4>
                            </div>
                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered" id="subjectTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?=htmlspecialchars($Residents['resident_name']) ?></td>
                                                        <td><?="Purok/Zone " . htmlspecialchars($Residents['purok_zone']) ?></td>
                                                        <td><?=htmlspecialchars($Residents['gender']) ?></td>
                                                        <td><?=htmlspecialchars($Residents['age']) ?></td>
                                                        <td><?=htmlspecialchars($Residents['enumCivilStatus']) ?></td>
                                                        <td><?=htmlspecialchars($Residents['occupation']) ?></td>                                                        
